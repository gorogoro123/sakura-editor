...
//	2001/06/19	asa-o
	...
	/* 入力補完 単語ファイル */
	ApiWrap::DlgItem_GetText( hwndDlg, IDC_EDIT_HOKANFILE, m_Types.m_szHokanFile, m_Types.m_szHokanFile.capacity() );
	...
	//@@@ 2002.2.2 YAZAKI
	ApiWrap::DlgItem_GetText( hwndDlg, IDC_EDIT_TYPEEXTHELP, m_Types.m_szExtHelp, m_Types.m_szExtHelp.capacity() );
	ApiWrap::DlgItem_GetText( hwndDlg, IDC_EDIT_TYPEEXTHTMLHELP, m_Types.m_szExtHtmlHelp, m_Types.m_szExtHtmlHelp.capacity());
