...
void CPropTypesWindow::SetData( HWND hwndDlg )
{
	...
	// 背景画像
	ApiWrap::EditCtl_LimitText(GetDlgItem(hwndDlg, IDC_EDIT_BACKIMG_PATH), m_Types.m_szBackImgPath.capacity());
	...
	/* 行番号区切り文字 */
	wchar_t	szLineTermChar[2] = { m_Types.m_cLineTermChar };
...
int CPropTypesWindow::GetData( HWND hwndDlg )
{
	...
	ApiWrap::DlgItem_GetText(hwndDlg, IDC_EDIT_BACKIMG_PATH, m_Types.m_szBackImgPath, m_Types.m_szBackImgPath.capacity());
