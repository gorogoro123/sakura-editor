...
{
	//名前と拡張子
	pType->m_szTypeName = L"テキスト";
	pType->m_szTypeExts = L"txt,log,1st,err,ps";
	...
	pType->m_szKinsokuHead = L"!%),.:;?]}\xa2°’”‰′″℃、。々〉》」』】〕゛゜ゝゞ・ヽヾ！％），．：；？］｝｡｣､･ﾞﾟ￠";		/* 行頭禁則 */	//@@@ 2002.04.13 MIK 
	pType->m_szKinsokuTail = L"$([\\{\xa3\xa5‘“〈《「『【〔＄（［｛｢￡￥";		/* 行末禁則 */	//@@@ 2002.04.08 MIK 
	...
	::wcsncpy_s(&pKeyword[keywordPos],			// 正規表現キーワード
		pType->m_RegexKeywordList.capacity() - keywordPos,
