...
struct STypeConfig{
	...
	StaticString<MAX_TYPES_EXTS>	m_szTypeExts;		//!< タイプ属性：拡張子リスト
	...
	StaticString<8+1>	m_szTabViewString;				//!< TAB表示文字列	// 2003.1.26 aroka サイズ拡張	// 2009.02.11 ryoji サイズ戻し(17->8+1)
	...
	StaticString<200>	m_szKinsokuHead;				//!< 行頭禁則文字	//@@@ 2002.04.08 MIK
	StaticString<200>	m_szKinsokuTail;				//!< 行頭禁則文字	//@@@ 2002.04.08 MIK
	StaticString<200>	m_szKinsokuKuto;				//!< 句読点ぶらさげ文字	// 2009.08.07 ryoji
	...
	bool				m_bDetectIndentationStyleOnFileLoad;	//!< ファイル読み込み時にインデントスタイルを検出して一時設定する
...
//@@@ 2001.11.17 add start MIK
	...
	StaticString<MAX_REGEX_KEYWORDLISTLEN>	m_RegexKeywordList;			//!< 正規表現キーワード
