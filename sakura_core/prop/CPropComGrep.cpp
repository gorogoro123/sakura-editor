...
void CPropGrep::SetData( HWND hwndDlg )
{
	...
	ApiWrap::EditCtl_LimitText( ::GetDlgItem( hwndDlg, IDC_EDIT_REGEXPLIB ), m_Common.m_sSearch.m_szRegexpLib.capacity() - 1 );
...
int CPropGrep::GetData( HWND hwndDlg )
{
	...
	//	2007.08.12 genta 正規表現DLL
	ApiWrap::DlgItem_GetText( hwndDlg, IDC_EDIT_REGEXPLIB, m_Common.m_sSearch.m_szRegexpLib, m_Common.m_sSearch.m_szRegexpLib.capacity());
