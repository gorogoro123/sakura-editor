...
//※サクラ依存
void GetExedir( std::span<WCHAR> pDir, LPCWSTR szFile = nullptr );
void GetInidir( std::span<WCHAR> pDir, LPCWSTR szFile = nullptr ); // 2007.05.19 ryoji
void GetInidirOrExedir( std::span<WCHAR> pDir, LPCWSTR szFile = nullptr, BOOL bRetExedirIfFileEmpty = FALSE ); // 2007.05.22 ryoji
