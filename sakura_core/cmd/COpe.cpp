...
{
	assert( eCode != EOpeCode::OPE_UNKNOWN );
	m_nOpe = eCode;					// 操作種別
...
void COpe::DUMP( )
{
	...
	DEBUG_TRACE( L"\t\tm_ptCaretPos_PHY_Before = [%d,%d]\n", static_cast<int>(m_ptCaretPos_PHY_Before.x), static_cast<int>(m_ptCaretPos_PHY_Before.y) );
	DEBUG_TRACE( L"\t\tm_ptCaretPos_PHY_After  = [%d,%d]\n", static_cast<int>(m_ptCaretPos_PHY_After.x), static_cast<int>(m_ptCaretPos_PHY_After.y) );
	return;
}
...
{
	COpe::DUMP();
	DEBUG_TRACE( L"\t\tm_ptCaretPos_PHY_To     = [%d,%d]\n", static_cast<int>(m_ptCaretPos_PHY_To.x), static_cast<int>(m_ptCaretPos_PHY_To.y) );
